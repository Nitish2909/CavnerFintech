        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 animate-fade-in">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-tight md:leading-none bg-clip-text text-transparent bg-gradient-to-r from-slate-900 via-slate-800 to-cyan-950">
              Project & Capex Finance | Funding For &amp; Big Plan and Bigger
              Execution.
            </h1>
            ...
            <div className="space-y-4 text-sm md:text-base text-gray-600 leading-relaxed max-w-2xl">
              <p className="transition-colors duration-300 hover:text-slate-900">
                Expansion plans need more than ideas. They need money at the
                right time. Businesses often dream big. They want to build new
                factories. They want to buy modern machines. They want to launch
                large infrastructure projects. But all of this requires planned
                investment. These are not small expenses. These are long-term
                commitments. A company cannot always fund such growth only
                through daily cash flow. That is where Project & Capex Finance
                becomes important. It supports businesses that want to invest in
                long-term assets. It helps companies execute projects without
                stopping midway.
              </p>
              <p className="transition-colors duration-300 hover:text-slate-900">
                Many projects fail not because the idea is weak, but because
                funding is delayed. Cash gaps slow down construction. Vendor
                payments get postponed. Labour work suffers. Material costs rise
                over time. Timelines stretch. The overall project cost becomes
                higher than expected. With capex funding solutions, businesses
                can avoid such problems. This financing is designed for large
                investments like new plants, equipment purchases, and
                expansion-driven projects. Funds are released in a structured
                way. Disbursement happens step by step based on project
                progress. This keeps execution disciplined. Repayment is also
                planned predictably. It is aligned with business cash flow and
                ...
                <div
                  ...
                  className={`w-full shrink-0 px-2 lg:px-0 lg:w-auto transform transition-all duration-300 ${
                    index === currentStep
                      ...
                      : "scale-95 opacity-50 lg:scale-100 lg:opacity-100"
                  }`}
                >
              ...
              {steps.map((_, idx) => (
                <button
                  ...
                  className={`h-2.5 rounded-full transition-all duration-300 ${
                    idx === currentStep
                      ? "w-8 bg-cyan-500 shadow-xs shadow-cyan-500/40"
        ...
        <div className="bg-gradient-to-br from-white to-slate-50 rounded-3xl border border-slate-200/60 p-6 md:p-10 space-y-5 shadow-xs relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-600 leading-relaxed">
            <p className="transition-colors duration-300 hover:text-slate-950">
              ...
              managing cash flow, meeting timelines, and executing the project
              as promised. A builder may have a strong vision and a good
              location, but without timely funding, progress can slow down
              quickly.
            </p>
            <p className="transition-colors duration-300 hover:text-slate-950">
                  ...
                  <div>
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs md:text-sm text-gray-600">
                      <li className="flex items-start gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-xs transition-all hover:border-slate-200">
                        ...
                        />{" "}
                        <span className="leading-relaxed">
                          KYC of Partnership Firm/LLP (PAN Card Copy +
                          Registered Partnership/LLP Deed)
                        </span>
                      </li>
                      <li className="flex items-start gap-3 bg-white p-3 rounded-xl border border-slate-100 shadow-xs transition-all hover:border-slate-200">
                        <CheckCircle
