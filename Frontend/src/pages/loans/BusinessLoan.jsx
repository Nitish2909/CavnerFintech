          ...
          <div className="lg:col-span-7 space-y-8 mt-4">
            <div className="space-y-4">
              ...
              <p className="text-base md:text-lg text-gray-600 leading-relaxed font-medium">
               A business loan is a financial solution designed to help small and large businesses to access funds to manage cash flow, operational expenses, business expansion and growth. Compare and apply for best business loan offers up to Rs. 1 crore from 20+ RBI-regulated banks, non-banking financial companies (NBFCs), and other financial institutions. Cavner Wealth & FinTech help you to get business loans at lowest interest rates and quick disbursal with minimal documentation.
              </p>
            </div>
          ...
          <div className="lg:col-span-5 bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden sticky top-8 transition-transform duration-300 hover:shadow-2xl">
            <div className="bg-gradient-to-r from-emerald-500/10 to-teal-500/10 px-6 py-4 border-b border-dashed border-emerald-500/20 flex items-center justify-between">
              <span className="text-[10px] font-bold text-emerald-800 tracking-wider uppercase bg-emerald-100 px-2.5 py-1 rounded-md">
                EXCLUSIVE SYSTEM BONUS
              </span>
              <span className="text-xs text-emerald-700 font-bold animate-pulse">
                ₹1,000 Cash Credit Pending*
              </span>
            </div>

            <form onSubmit={handleMainFormSubmit} className="p-8 space-y-6">
              <div className="space-y-1 text-center">
                <span className="text-xs font-bold text-blue-600 uppercase tracking-widest block">Instant Verification Link</span>
                <h3 className="text-2xl font-black text-gray-900 tracking-tight">Check Approval Rate</h3>
              </div>
              ...
              >
                <span>{isSubmittingLead ? "Processing Secure Tokens..." : "Generate Offers"}</span>
