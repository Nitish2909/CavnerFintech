  ...
  const baseOffers = [
    {
      ...
      interestRate: 9.6,
      maxAmount: 2500000,
      displayAmount: "₹25 Lakh",
      displayFees: "Upto 1.5%",
      displayRate: "9.60% onwards",
    },
    {
      id: 2,
      bankName: "ICICI Bank",
      ...
      interestRate: 9.99,
      maxAmount: 20000000,
      displayAmount: "₹2 Crore",
      displayFees: "Upto 2.5%",
      displayRate: "9.99% onwards",
    },
    {
      id: 3,
      bankName: "HDFC Bank",
      ...
      interestRate: 10.45,
      maxAmount: 5000000,
      displayAmount: "₹50 Lakh",
      displayFees: "₹4,999 + GST",
      displayRate: "10.45% onwards",
    },
    {
      id: 4,
      bankName: "Axis Bank",
      ...
      interestRate: 9.95,
      maxAmount: 4000000,
      displayAmount: "₹40 Lakh",
      displayFees: "Upto 2%",
      displayRate: "9.95% onwards",
    },
    {
      id: 5,
      ...
      maxAmount: 5000000,
      displayAmount: "₹50 Lakh",
      displayFees: "₹1,299 + GST",
      displayRate: "10.99% onwards",
    },
    {
      id: 6,
      ...
      maxAmount: 4000000,
      displayAmount: "₹40 Lakh",
      displayFees: "Upto 3.99%",
      displayRate: "11.00% onwards",
    },
  ];
  ...
  const filteredOffers = useMemo(() => {
    ...
    if (filters.processingTime) {
      output = output.filter(
        (offer) => offer.processingTime === filters.processingTime,
      );
    }
          ...
          <div className="lg:col-span-7 space-y-8 mt-4">
            ...
            <div className="grid grid-cols-3 gap-4 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow duration-300">
              <div className="text-center border-r border-gray-100">
                <span className="block text-2xl md:text-3xl font-black text-blue-600 tracking-tight">
                  9.60%
                </span>
              ...
              <div className="text-center border-r border-gray-100">
                <span className="block text-2xl md:text-3xl font-black text-emerald-600 tracking-tight">
                  24 Hrs
                </span>
                <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider block mt-1">
                  Avg Disbursal
              ...
              <div className="text-center">
                <span className="block text-2xl md:text-3xl font-black text-indigo-600 tracking-tight">
                  56 Live
                </span>
                <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider block mt-1">
                  Integrated Lenders
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {["Instant", "1 - 2 Days", "3 - 5 Days"].map((time) => (
                    <label
                      key={time}
                      className="flex items-center space-x-3 text-sm text-gray-600 hover:text-gray-900 cursor-pointer select-none group"
                    >
                      <input
                        type="radio"
                        name="processingTime"
                        ...
                        onChange={() =>
                          handleFilterChange("processingTime", time)
                        }
                  ...
                  {["Lowest", "Highest"].map((rate) => (
                    ...
                    >
                      <input
                        ...
                        onChange={() =>
                          handleFilterChange("interestRate", rate)
                        }
                        className="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500/20 cursor-pointer"
                      />
                      <span
                  ...
                  {["Lowest", "Highest"].map((amount) => (
                    ...
                    >
                      <input
                        ...
                        onChange={() =>
                          handleFilterChange("loanAmount", amount)
                        }
                        className="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500/20 cursor-pointer"
                      />
                      <span
            ...
            <div className="lg:col-span-9 space-y-4 max-h-[85vh] overflow-y-auto pr-2 custom-scrollbar">
              {filteredOffers.length > 0 ? (
                filteredOffers.map((offer) => (
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-4 min-w-[240px]">
                      ...
                      <h3 className="text-base font-bold text-gray-900 tracking-tight group-hover:text-blue-600 transition-colors duration-150">
                        {offer.bankName}
                      </h3>
                    </div>
                ...
                <div className="bg-white border border-gray-200 border-dashed rounded-3xl p-16 text-center text-gray-400">
                  ...
                  <button
                    onClick={clearFilters}
                    className="text-xs font-bold text-blue-600 mt-2 bg-blue-50 px-3 py-1.5 rounded-lg"
                  >
                    Reset Filter Tree
                  </button>
                </div>
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-8 shadow-2xl border border-gray-100 relative animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="space-y-6 text-center">
              <div
                className={`mx-auto w-16 h-16 rounded-full bg-gradient-to-br ${selectedBank.bgGradient} p-0.5 flex items-center justify-center shadow-md`}
              >
                <div className="w-full h-full rounded-full bg-white flex items-center justify-center p-2 overflow-hidden">
                  ...
                  />
                  <span className="hidden font-black text-gray-800 text-xs">
              ...
              <div className="bg-slate-50 p-4 rounded-2xl text-left text-xs space-y-2.5 text-gray-600 border border-gray-100/70">
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Target Interest Tier:</span>{" "}
                  <span className="font-bold text-emerald-600">
                    {selectedBank.displayRate}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Maximum Allocation:</span>{" "}
                  <span className="font-bold text-gray-900">
                    {selectedBank.displayAmount}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Processing Overhead:</span>{" "}
                  <span className="font-bold text-gray-900">
                    {selectedBank.displayFees}
                  </span>
                </div>
              </div>
              ...
              <div className="flex space-x-3 pt-2">
                <button
                  onClick={() => setSelectedBank(null)}
                  className="flex-1 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold rounded-xl transition text-xs"
                >
                  Go Back
                </button>
                <button
